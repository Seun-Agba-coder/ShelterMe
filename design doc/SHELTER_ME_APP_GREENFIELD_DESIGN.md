# New Project Template: ShlterMe App MVP
## 1. Introduction
...
### 1.2 Scope
The architecture covers the MVP of the Curriculum App, focusing on UserAccountManagment, Student feature, AgentFeature, Payment GateWay, AdminFeature.
...
- **Business Owners:** Stakeholders interested in the commercial success and growth of the app (At the moment All the developers).
### 3.2 System Concerns
...
- **Back-End Module:** Manages server-side logic, API requests, and database interactions, business logic .
- **Database Module:** Stores and retrieves all application data.
### 6.2 Component Diagrams
[![ShlterMe - Component Diagram](https://app.eraser.io/workspace/M5myBfYqgc4DFNqz971S/preview?elements=20EaF6gDD2c1rTEiwIai6w&type=embed)](https://app.eraser.io/workspace/M5myBfYqgc4DFNqz971S?elements=20EaF6gDD2c1rTEiwIai6w)

### 6.3 Database Design 
* (implemeted later)

Auth Databse: Stores all the user authentication details

User Database: Stores all the user info. 

-Student Databas: User Database but for student

-Agent User Database: User Database but for Agent

-Admin User Database: User Database bur for Agent

Property Database: Stores all the Property listing info.

Property_Image Database: Stores all the property Images Listing.

PendingDatabase:  Have a link to the PropertyDatabase and stores Pending Status.

BookedDatabase: Have  a link to the PropertyDatabase and stores the PendingDatabase.

Message Database*: Stores all the Real Time Messaging Chat.

Payment Database*: Stores all the payment Receipt.

[![ShlterMe DB](https://app.eraser.io/workspace/M5myBfYqgc4DFNqz971S/preview?elements=hlkMwQpU65K3Wds6T8qFeQ&type=embed)](https://app.eraser.io/workspace/M5myBfYqgc4DFNqz971S?elements=hlkMwQpU65K3Wds6T8qFeQ)
...
- **User Adoption:** Risks related to Trust and user acquisition.
...
<!--- Eraser file: https://app.eraser.io/workspace/DAj9vfxZwqkGhQDqygSb --->
